...
const errorTypes = {
  ...
  TELEPHONE_NUMBER_TAKEN: {
    description: 'This telephone number already taken, try use another',
    status: 409,
    code: 'TELEPHONE_NUMBER_ALREADY_TAKEN_ERROR',
  },
  NO_MONEY_AVAILABLE: {
    description: 'There is no money left for the transaction', 
    status: 51, 
    code: 'NO_MONEY_AVAILABLE_ERROR', 
  },
};
